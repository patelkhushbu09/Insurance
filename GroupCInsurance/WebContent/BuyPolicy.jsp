  ...
  <span class="login100-form-title p-b-37" style="padding-bottom: 0px;">
      ...
      <div class="table100 ver5 m-b-110">
			...
			<form action="ControllerServlet" method="POST" class="login100-form validate-form">
      		<input type="hidden" name="page" value="buypolicycust">
            <table>
              <thead>
                <tr class="row100 head">
                	<th></th>
                  <th class="cell100 column1">POLICY NAME</th>
                  <th class="cell100 column2">NUMBERS OF NOMINEE</th>
                  <th class="cell100 column3">TENURE</th>
                  <th class="cell100 column4">SUM ASSURED</th>
              ...
              <%try{
            	  ...
            	  ResultSet rs =statement.executeQuery("select * from policy") ;
            	  while(rs.next()){%>
            	  <tr class="row100 body">
            	  <td><input type="radio" name="selectradio" value=<%=rs.getString(1) %> style="position: inherit; 
            	  margin-left: 20px;"></td>
            	  <td class="cell100 column1"><%=rs.getString(2) %></td>
            	  <td class="cell100 column2"><%=rs.getInt(3) %></td>
            	  <td class="cell100 column3"><%=rs.getString(4) %></td>
            	  <td class="cell100 column4" name="sumassured"><%=rs.getFloat(5) %></td>
            	  <td class="cell100 column4">
            	  	<div class="container-login100-form-btn" align="center">
          				<input type="submit" name="buypolicy" value="BUY" class="login100-form-btn" style="margin-bottom: 0px;">
          				</input>
        			</div>
        		</td>
                </tr>
		...
		<form action="ControllerServlet" method="GET">
      	<input type="hidden" name="navigate" value="buypolicycustlink">
