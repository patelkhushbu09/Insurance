...
<% String successMsg=(String) request.getAttribute("successMessage");
      ...
      <div class="table100 ver5 m-b-110">
			...
			<form action="ControllerServlet" method="POST" class="login100-form validate-form">
      		<input type="hidden" name="page" value="adminmcta">
            <table>
              <thead>
                <tr class="row100 head">
                  ...
                  <th class="cell100 column3">AGENT</th>
              ...
              <%try{
                ...
                <tr class="row100 body">
                	<td><input type="radio" name="selectradio" value=<%=rs.getString(3)%> style="position: inherit; margin-left: 20px;"></td>
                  <td class="cell100 column1"><%=rs.getString(2) %></td>
              	  <td class="cell100 column2"><%=rs.getString(1) %></td>
                  <td class="cell100 column3" style="width: 50px;">
            <div class="wrap-input100 validate-input m-b-20" style="margin-bottom: 0px;">
            <select name=<%=rs.getString(3)%> id="list" onchange="getSelectedValue();" style="height: 40px; border: none; width: 200px; margin-left: 15px; ">
            <option value=""></option>
            <%!ResultSet rs1 = null; %>
              <%try{
            	  Class.forName("oracle.jdbc.driver.OracleDriver");
            	  ...
            	  rs1 =statement1.executeQuery("select * from agent");
            	  while(rs1.next()){%>
             ...
             <td class="cell100 column4" style="width:15%;"><div class="container-login100-form-btn" align="center">
            				<input type="submit" name="mapButton" value="MAP" id="map" 
...
<form action="ControllerServlet" method="GET">
      	<input type="hidden" name="navigate" value="mctaink">
