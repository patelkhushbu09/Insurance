...
<div class="module form-module">
  <div class="toggle">
    ...
    <div class="form">
    <h2>Sign Up</h2>
    <form action="avnregister" method="post">
      <input type="text" name="username" placeholder="Username"/>
	  <input type="text" name="userfname" placeholder="Firstname"/>
	  <input type="text" name="userlname" placeholder="Lastname"/>
